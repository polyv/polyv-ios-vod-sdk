...
**自 2.19.0 版本开始，本地播放视频鉴权方式进行了调整，为了在覆盖升级时兼容已下载的旧版本视频，必须要在视频播放前，手动调用迁移方法。**
 ...
 */
- (void)migrateLocalVideoPlaylist:(NSString*)secretKey;
```

**注意：**

1. 旧版本升级至 2.19.0 版本的点播 SDK，需要同步更新 2.19.0 版本的 Demo 层代码，以获得本次新增的功能。
2. 若不便直接更新源码，可根据 [diff 变动内容](https://github.com/polyv/polyv-ios-vod-sdk/compare/2.18.4...2.19.0-abn) 查看 Demo 层的变动，手动更新Demo层源码
